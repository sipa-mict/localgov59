 ...
 */
if ( $wp_version >= '3.6' ) {
	function divertheme_remove_customize_submenu_page() {
		remove_submenu_page( 'themes.php', 'customize.php' );
	}

	add_action( 'admin_menu', 'divertheme_remove_customize_submenu_page' );
}

function divertheme_add_customizer_menu() {
	add_menu_page( 'Customizer', 'ปรับแต่ง', 'edit_theme_options', 'customize.php', null, null, 61 );
}

add_action( 'admin_menu', 'divertheme_add_customizer_menu' );
 ...
 * ============================================================================
 */
function divertheme_remove_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'divertheme_remove_customizer_sections' );
 ...
 */
function divertheme_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'divertheme_customize_register' );
...
function register_sections_site_background( $wp_customize ) {
	$wp_customize->add_section( 'background_image', array(
		'title'       => __( 'พื้นหลัง', 'divertheme' ),
		'description' => __( 'In this section you can change background image of the site', 'divertheme' ),
		'priority'    => 125,
	) );
}
 ...
 * ============================================================================
 */
function divertheme_customize_preview_js() {
	wp_enqueue_script( 'divertheme_customizer', THEME_ROOT . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}

add_action( 'customize_preview_init', 'divertheme_customize_preview_js' );
 ...
 * ============================================================================
 */
require_once get_template_directory() . '/inc/customizer/section__basic.php';
 ...
 * ============================================================================
 */
if ( ! function_exists( 'divertheme_get_color_scheme' ) ) :
	function divertheme_get_color_scheme() {
		$color_scheme_option = get_theme_mod( 'site_color_scheme', 'scheme1' );
		$color_schemes       = divertheme_get_color_schemes();
		global $divertheme_color_scheme;

		if ( $divertheme_color_scheme == 'default' ) {
			return $color_schemes[ $color_scheme_option ]['colors'];
		} elseif ( $divertheme_color_scheme != 'default' && $divertheme_color_scheme != '' ) {
			return $color_schemes[ $divertheme_color_scheme ]['colors'];
...
endif; // divertheme_get_color_scheme

if ( ! function_exists( 'divertheme_get_color_scheme_choices' ) ) :
	function divertheme_get_color_scheme_choices() {
		$color_schemes                = divertheme_get_color_schemes();
