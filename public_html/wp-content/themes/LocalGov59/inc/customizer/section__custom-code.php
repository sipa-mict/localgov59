...
function register_sections_custom_code( $wp_customize ) {
	...
	$wp_customize->add_section( 'custom_code_section', array(
		'title'       => __( 'Custom Code', 'divertheme' ),
		'description' => __( 'In this section you can add custom JavaScript and CSS to your site.', 'divertheme' ),
		'priority'    => 160
	) );
...
function register_controls_for_custom_code_section( $controls ) {
	...
	$controls[] = array(
		...
		'label'     => __( 'Custom CSS', 'divertheme' ),
		'section'   => $section,
		'separator' => false,
		'priority'  => $priority ++
	);
	...
	$controls[] = array(
		...
		'subtitle'  => __( 'Enabling this option will apply custom css to your site', 'divertheme' ),
		'section'   => $section,
		'separator' => false,
	...
	$controls[] = array(
		...
		'label'     => __( 'Custom Javascript', 'divertheme' ),
		'section'   => $section,
		'separator' => false,
		'priority'  => $priority ++
	);
	...
	$controls[] = array(
		...
		'subtitle'  => __( 'Enabling this option will apply custom Javascript to your site', 'divertheme' ),
		'section'   => $section,
		'separator' => false,
	...
	$controls[] = array(
		...
		'label'       => __( 'Custom JavaScript', 'divertheme' ),
		'section'     => $section,
		'placeholder' => __( 'Entry your custom js code here', 'divertheme' ),
		'priority'    => $priority ++
	);
