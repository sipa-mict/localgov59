...
function register_sections_typo( $wp_customize ) {
	$wp_customize->add_section( 'site_typography_section', array(
		'title'       => __( 'Typography', 'divertheme' ),
		'description' => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci earum est, explicabo id illo quae!', 'divertheme' ),
		'priority'    => 120,
	) );
}
...
function register_controls_for_site_typography_section( $controls ) {
	...
	$controls[] = array(
		...
		'label'     => __( 'Font Family', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'Heading Font', 'divertheme' ),
		'section'   => $section,
		'separator' => false,
		'priority'  => $priority ++
	);
	...
	$controls[] = array(
		...
		'label'     => __( 'H1 Font Size', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'H2 Font Size', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'H3 Font Size', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'H4 Font Size', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'H5 Font Size', 'divertheme' ),
		'section'   => $section,
	...
	$controls[] = array(
		...
		'label'     => __( 'H6 Font Size', 'divertheme' ),
		'section'   => $section,
