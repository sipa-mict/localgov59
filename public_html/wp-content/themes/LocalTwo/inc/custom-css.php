<?php
function divertheme_css_custom_code() {
	...
	<style type="text/css">
		...
		a.vc_btn.vc_btn_blue.vc_grid-btn-load_more,
		#listcategorypostswidget-2 > ul >li:hover {
			background-color: <?php echo get_theme_mod( 'post_li_background',$color_scheme[99]) ?>;
		}

		.scheme .footer-copyright {
			color: <?php echo get_theme_mod( 'copyright_text_color',$color_scheme[24]) ?>;
		}

		.hentry .mejs-mediaelement,
		.hentry .mejs-container .mejs-controls {
			background: <?php echo get_theme_mod( 'media_background',$color_scheme[98]) ?>;
		}

		.wp-caption .wp-caption-text,
		.entry-caption,
		.gallery-caption {
			color: <?php echo get_theme_mod( 'media_background',$color_scheme[98]) ?>;
		}

		.attachment .hentry {
			background: <?php echo get_theme_mod( 'attachment_hentry',$color_scheme[97]) ?>;
		}
			
		.hentry .mejs-controls .mejs-time-rail .mejs-time-current {
			background: <?php echo get_theme_mod( 'hentry_time_background',$color_scheme[96]) ?>;
		}

		blockquote {
		    border-left: 5px solid <?php echo get_theme_mod( 'secondary_color',$color_scheme[99]) ?>; !important;
		    padding: 15px 15px;
		    background: #efefef;
		...
		a.eg-divertheme-company-news-element-18 {
			color: #999;
		}

		h1, h2, h3, h4, h5,
		.eg-divertheme-features-1-element-0,
		.eg-divertheme-features-2-element-0,
		.eg-divertheme-company-news-element-0,
		.eg-divertheme-features-3-element-0,
		.eg-divertheme-features-2-element-15,
		.eg-divertheme-features-4-element-15,
		.eg-divertheme-features-3-element-18,
		.eg-divertheme-company-news-element-18,
		.eg-divertheme-blog-element-0,
		.eg-divertheme-blog-element-3,
		.scheme a.read-more,
		.navigation,
		.intro,
		.vc_progress_bar,
		...
		.dates,
		.share,
		.eg-divertheme-feature-4-element-0,
		.eg-divertheme-feature-4-element-15,
...
add_action( 'wp_head', 'divertheme_css_custom_code' );