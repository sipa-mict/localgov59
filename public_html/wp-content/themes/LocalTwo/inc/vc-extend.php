...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_divertheme_Recentposts extends WPBakeryShortCode {
	}

	class WPBakeryShortCode_divertheme_Testi extends WPBakeryShortCode {
	}

	class WPBakeryShortCode_divertheme_Gmaps extends WPBakeryShortCode {
	...
	class WPBakeryShortCode_divertheme_Project_Details extends WPBakeryShortCode {
	}
}
...
//Latest Posts
vc_map( array(
	'name'     => __( 'Recent Posts 2', 'divertheme' ),
	'base'     => 'divertheme_recentposts',
	'category' => __( 'by divertheme', 'divertheme' ),
	'params'   => array(
		array(
			'type'       => 'checkbox',
...
// divertheme Google Maps
vc_map( array(
	'name'     => __( 'Google Maps', 'divertheme' ),
	'base'     => 'divertheme_gmaps',
	'category' => __( 'by divertheme', 'divertheme' ),
	'params'   => array(
		array(
			'type'        => 'textfield',
			...
			'description' => __( 'Enter address or coordinate. To learn how to get coordinates, visit <a href="https://support.google.com/maps/answer/18539?hl=en" target="_blank">here</a>', 'divertheme' ),
		),
		array(
			'type'        => 'attach_image',
			'heading'     => "Marker icon",
			'param_name'  => 'marker_icon',
			'description' => __( 'Choose a image for marker address', 'divertheme' ),
		),
		array(
			'type'        => 'textarea_html',
			'heading'     => "Marker Information",
			'param_name'  => 'content',
			'description' => __( 'Content for info window', 'divertheme' ),
		),
		array(
			'type'        => 'textfield',
			'heading'     => "Height",
			...
			'value'       => '480',
			'description' => __( 'Enter map height (in pixels or percentage)', 'divertheme' ),
		),
		array(
			'type'        => 'textfield',
			'heading'     => "Width",
			...
			'value'       => '100%',
			'description' => __( 'Enter map width (in pixels or percentage)', 'divertheme' ),
		),
		array(
			'type'        => 'textfield',
			'heading'     => "Zoom level",
			'param_name'  => 'zoom',
			'value'       => '16',
			'description' => __( 'Map zoom level', 'divertheme' ),
		),
		array(
			'type'       => 'checkbox',
		...
		array(
			...
			'admin_label' => true,
			'param_name'  => 'map_type',
			'description' => __( 'Choose a map type', 'divertheme' ),
			'value'       => array(
				'Roadmap'   => 'roadmap',
				'Satellite' => 'satellite',
				'Hybrid'    => 'hybrid',
		...
		array(
			...
			'description' => __( 'Choose a map style. This approach changes the style of the Roadmap types (base imagery in terrain and satellite views is not affected, but roads, labels, etc. respect styling rules', 'divertheme' ),
			'value'       => array(
				'Default'          => 'default',
				'Grayscale'        => 'style1',
		...
		array(
			...
			'description' => __( 'To get the style snippet, visit <a href="https://snazzymaps.com" target="_blank">Sanzzymaps</a> or <a href="http://www.mapstylr.com/" target="_blank">Mapstylr</a>.', 'divertheme' ),
			'dependency'  => array(
				'element' => 'map_style',
				'value'   => 'custom',
			)
		...
		array(
			...
			'heading'     => "Extra class name",
			'param_name'  => 'el_class',
			'description' => __( 'If you want to use multiple Google Maps in one page, please add a class name for them.', 'divertheme' ),
		),
	)
) );

// divertheme Project Details
vc_map( array(
	'name'        => __( 'Project Details', 'divertheme' ),
	'description' => __( 'Only available for Projects.', 'divertheme' ),
	'base'        => 'divertheme_project_details',
	'category'    => __( 'by divertheme', 'divertheme' ),
	'params'      => array(
		array(
			'type'        => 'dropdown',
			...
			'admin_label' => true,
			'param_name'  => 'layout',
			'description' => __( 'Choose a layout to display project details', 'divertheme' ),
			'value'       => array(
				'Layout 1' => 'layout1',
				'Layout 2' => 'layout2'
			),
